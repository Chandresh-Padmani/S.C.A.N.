...
public class InputFrequencyDistribution extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_frequency);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_add: {
                ...
                if(value.equals("")){
                    Toast.makeText(InputFrequencyDistribution.this,"Enter Value",Toast.LENGTH_SHORT).show();
                    return;
                }
                else {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_home:
                Intent intent = new Intent(InputFrequencyDistribution.this, MainActivity.class);
                startActivity(intent);
                break;

            case R.id.nav_formulas:
                Intent intent2 = new Intent(InputFrequencyDistribution.this, EqFormulas.class);
